...
export class PrismaStorage implements IStorage {
  ...
  // User design project operations
  async getUserDesignProjects(userId: string): Promise<any[]> {
  ...
  async getDesignProject(id: string): Promise<any> {
  ...
  async createDesignProject(project: InsertUserDesignProject): Promise<any> {
  ...
  async updateDesignProject(id: string, updates: Partial<InsertUserDesignProject>): Promise<any> {
